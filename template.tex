...
%######### KAPITEL EINFÜGEN ##############
\input{C_Inhalt/01_chapter1}
\input{C_Inhalt/02_chapter2}
...
\printbibliography[heading=bibintoc] % Fügt die Bibliographie mit Kapitelüberschrift ins Inhaltsverzeichnis ein
